...
namespace Lab5
{
    ...
    struct Geograf
    {
        ...
        public void Print(string path, List<Geograf> list)
        {
            Console.WriteLine();
                ...
                try
                {
                    ...
                    else if (choice is Functions.Sort)
                    {
                        ...
                        for (int i = 0; i < list.Count; i++)
                        {
                            ...
                            {
                                if (Convert.ToInt32(list[j].people) < Convert.ToInt32(list[index].people))
                                {
                                    index = j;
                                }
                            }
                            if (Convert.ToInt32(list[index].people) == Convert.ToInt32(list[i].people))
                            {
                                continue;
                            }
                            else
